...
<%@page import="com.pharmacy.UserProfile" %>
<!DOCTYPE html>
<html lang="en">
...
<body class="hold-transition sidebar-mini layout-fixed">
	<%
	    ...
	    else
	    {
	    	...
	    	// UserProfile doctor = (UserProfile) session.getAttribute("doctor_object");
                ...
                <div class="card" style="margin-top: 20px;">
                    ...
                    <div id="settings" style="padding: 30px;">
                        <form class="form-horizontal" action="/pharmacy/ProfileUpdateServlet" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmpolyeeName" class="col-sm-2 col-form-label">Employee Name:</label>
                                <div class="col-sm-10">
                                    <p class="form-control" id="userEmployeeName" style="border: none; margin-left: -10px;">Dr. <%=name %> </p>
                                </div>
                            </div>
                            <div class="form-group row">

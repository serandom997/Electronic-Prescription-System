...
<body class="hold-transition sidebar-mini layout-fixed">
	<%
	    ...
	    String user=null;
	    if(session.getAttribute("user")==null || session.getAttribute("user") !="Pharmacist" ) {
	    ...
	    else
	    {
	    	...
	    	session.removeAttribute("prescription_token");
			session.removeAttribute("patient_id");
			session.removeAttribute("patient_name");
			session.removeAttribute("doctor_lastname");
			session.removeAttribute("doctor_firstname");
			session.removeAttribute("patient_allergies");
			session.removeAttribute("prescription_status");
			
			session.removeAttribute("druglistsize");
			...
			session.removeAttribute("listidlist");
			session.removeAttribute("prescriptionid");
                    ...
                    <div id="settings" style="padding: 30px;">
                        <form class="form-horizontal" action="/pharmacy/ProfileUpdateServlet" method="post">
                            <div class="form-group row">
                                <label for="inputUserName" class="col-sm-2 col-form-label">NRIC:</label>
                                <div class="col-sm-10">
                                    <p class="form-control" id="userName" style="border: none; margin-left: -10px;"><%=ic %></p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPatientName" class="col-sm-2 col-form-label">Pharmacist Name:</label>
                                <div class="col-sm-10">
                                    <p class="form-control" id="userPatientName" style="border: none; margin-left: -10px;"><%=name %></p>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="offset-sm-2 col-sm-10">
                                    <button type="submit" id="update_profile" class="btn" style="background-color: #109CF1; color: white;">Update Change</button>
                                </div>
                            </div>
                            <div class="form-group row">
                            	<div class="offset-sm-2 col-sm-10">
